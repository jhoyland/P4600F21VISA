...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_openInstruments(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
...
SWIGINTERN PyObject *_wrap_getAmplitude(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "getAmplitude", 3, 3, swig_obj)) SWIG_fail;
