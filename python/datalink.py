...
def findgen(rm: "ViSession", channel: "int") -> "ViSession":
    return _datalink.findgen(rm, channel)

def setSinWave(gen: "ViSession", channel: "int", amplitude: "double", frequency: "double", offset: "double", phase: "double") -> "ViStatus":
    return _datalink.setSinWave(gen, channel, amplitude, frequency, offset, phase)
