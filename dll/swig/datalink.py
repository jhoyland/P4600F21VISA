...
def displayWave(handle, channel):
    return _datalink.displayWave(handle, channel)

def setSinwave(handle, channel, frequency, amplitude, offset, phase):
