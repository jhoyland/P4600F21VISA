...
def OSC_setup(resource_manager: "ViSession") -> "ViSession":
    return _datalink.OSC_setup(resource_manager)

def FG_setup(resource_manager: "ViSession") -> "ViSession":
    return _datalink.FG_setup(resource_manager)

def resource_manager_setup() -> "ViSession":
    return _datalink.resource_manager_setup()
